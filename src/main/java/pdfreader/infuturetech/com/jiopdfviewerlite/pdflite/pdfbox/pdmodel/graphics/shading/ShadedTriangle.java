...
{
    protected final Point[] corner; // vertices coordinates of a triangle
     ...
     */
    ShadedTriangle(Point[] p, float[][] c)
    {
        corner = p.clone();
        color = c.clone();
     ...
     */
    private double edgeEquationValue(Point p, Point p1, Point p2)
    {
     ...
     */
    public float[] calcColor(Point p)
    {
