...
import pdfreader.infuturetech.com.jiopdfviewerlite.manipulation.OnManipulateProgressListener;
...
import pdfreader.infuturetech.com.jiopdfviewerlite.pdflite.pdfbox.pdmodel.interactive.annotation.PDAnnotationLink;
...
public class Splitter
{
     ...
     */
    public List<PDDocument> split( PDDocument document, OnManipulateProgressListener listener) throws IOException
    {
        destinationDocuments = new ArrayList<PDDocument>();
        sourceDocument = document;
        if(listener != null)
        {
            processPages(listener);
        }else{
            processPages();
        }
     ...
     */
    private void processPages(OnManipulateProgressListener listener) throws IOException
    {
...
//            Dividing by 200 to send the progress as half of the original progress
            listener.onProgress((int) (80+(i/(float)numberOfPages)*20));
        }
    }
    /**
     * Interface method to handle the start of the page processing.
