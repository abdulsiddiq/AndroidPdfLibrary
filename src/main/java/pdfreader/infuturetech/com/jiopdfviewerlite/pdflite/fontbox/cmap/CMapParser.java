 ...
 */
package pdfreader.infuturetech.com.jiopdfviewerlite.pdflite.fontbox.cmap;
...
public class CMapParser
{
    ...
    protected InputStream getExternalCMap(String name) throws IOException
    {
    	if(PDFResourceLoader.isReady()) {
    		return PDFResourceLoader.getStream("talks.infuturetech.com.jiopdfviewerlite.pdflite.fontbox/resources/cmap/" + name);
    	}
    	
    	// Fallback
        URL url = getClass().getResource("/talks.infuturetech.com.jiopdfviewerlite.pdflite.fontbox/resources/cmap/" + name);
        if (url == null)
        {
