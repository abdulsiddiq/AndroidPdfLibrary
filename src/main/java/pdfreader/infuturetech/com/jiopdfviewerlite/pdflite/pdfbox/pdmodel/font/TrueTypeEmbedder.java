...
import pdfreader.infuturetech.com.jiopdfviewerlite.pdflite.fontbox.ttf.HeaderTable;
import pdfreader.infuturetech.com.jiopdfviewerlite.pdflite.fontbox.ttf.HorizontalHeaderTable;
import pdfreader.infuturetech.com.jiopdfviewerlite.pdflite.fontbox.ttf.OS2WindowsMetricsTable;
...
import pdfreader.infuturetech.com.jiopdfviewerlite.pdflite.fontbox.ttf.TTFSubsetter;
...
abstract class TrueTypeEmbedder implements Subsetter
{
                     ...
                     boolean embedSubset) throws IOException
    {
        ...
        if (!embedSubset)
        {
            ...
            stream.getCOSObject().setLong(COSName.LENGTH1, stream.getByteArray().length);
