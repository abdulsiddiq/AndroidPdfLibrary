...
import pdfreader.infuturetech.com.jiopdfviewerlite.pdflite.pdfbox.pdmodel.font.PDVectorFont;
...
{
    private static final LogFactory.Log LOG = LogFactory.getLog(TTFGlyph2D.class);
    ...
    public Path getPathForGID(int gid, int code) throws IOException
    {
        ...
        // todo: expensive
        return new Path(glyphPath) ; // todo: expensive
    }
