...
import pdfreader.infuturetech.com.jiopdfviewerlite.pdflite.pdfbox.pdmodel.PDPageTree;
...
import pdfreader.infuturetech.com.jiopdfviewerlite.pdflite.pdfbox.util.QuickSort;
...
public class PDFTextStripper extends LegacyPDFStreamEngine
{
    ...
    static
    {
        String path = "talks.infuturetech.com.jiopdfviewerlite.pdflite.pdfbox/resources/text/BidiMirroring.txt";
