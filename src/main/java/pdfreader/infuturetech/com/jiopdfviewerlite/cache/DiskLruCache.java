package pdfreader.infuturetech.com.jiopdfviewerlite.cache;
...
public class DiskLruCache
{
        ...
        public static  DiskLruCache openCache( File cacheDir, long maxByteSize) {
            ...
            if (cacheDir.isDirectory() && cacheDir.canWrite() && PDFUtil.getUsableSpace(cacheDir) > maxByteSize) {
         ...
         * {@link DiskLruCache#openCache(File, long)} which runs some extra
        ...
        public static  File getDiskCacheDir(Context context, String uniqueName) {
            ...
            final String cachePath = PDFResourceLoader.getCacheDir();
        ...
        private  boolean writeBitmapToFile( Bitmap bitmap, String file) throws IOException, FileNotFoundException
        {
            ...
            try {
                out = new BufferedOutputStream(new FileOutputStream(file), PDFUtil.IO_BUFFER_SIZE);
